...
<p>
  <ul>
    <li>2024.09.11(수) - 2024.09.18(수) : 주제, 팀장 선정, 회의록 페이지 개설 및 작성</li>
    <li>2024.09.19(목) - 2024.09.22(일) : 기획의도 작성, 유사사이트 분석, 클라이언트 요구사항 분석, 유스케이스 다이어그램 작성, 개발환경 · 팀원별 업무분담 조정</li>
    <li>2024.09.23(월) - 2024.09.26(목) : 화면 설계, 사이트맵 작성</li>
    <li>2024.09.27(금) - 2024.09.30(월) : DB  설계</li>
    <li>2024.10.01(화) - 2024.10.22(화) : 프로젝트 구현 및 디버깅</li>
    <li>2024.10.23(수) - 2024.10.25(금) : 베타테스트 진행 및 오류 수정, 발표</li>
  </ul>
</p>
