		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="card-header py-3">
					<h6 class="m-0 font-weight-bold text-primary">트레이너 매칭</h6>
				...
				<div class="row container-fluid">
					...
					<div class="topdiv">
						<div class="membershiplistdiv">
							<div class="3pt ptcheck border-left-primary">
								pt3회권 <br> <br> 15만원 <input class="ptval"
									type="hidden" value="3">
							</div>
							<div class="5pt ptcheck border-left-primary">
								pt5회권 <br> <br> 20만원 <input class="ptval"
									type="hidden" value="5">
							</div>
						</div>
						<div class="membershiplistdiv">
							<div class="10p ptcheck border-left-primary">
								pt10회권 <br> <br> 35만원 <input class="ptval"
									type="hidden" value="10">
							</div>
							<div class="20p ptcheck border-left-primary">
								pt20회권 <br> <br> 60만원 <input class="ptval"
									type="hidden" value="20">
							</div>
						</div>
						<div class="buydiv ">
							<button class="buybtn  btn btn-primary btn-icon-split btn-lg"
						...
						$('.buybtn').on(
								...
								function() {
									...
									if (loginUserid === ""
										...
										if (isSelected) {
											let num = ($('.selected .ptval')
													.val());
											window.open('shop.do?orderpt='
													+ num, '_blank',
					...
					<div style="width: 100%; margin-top: 30px;">
						...
						<h2 class="pttime"></h2>
						<input type="hidden" class="pId"> <br>
					</div>
					<c:forEach var="t" items="${list}">
						<div class="col-lg-6">
							<div class="card mb-4 py-3 border-left-primary test"
								...
								<div class="namecard"
									...
									<div style="width: 60%; height: 100%">
										<div class="namenone">
											<h5>${ t.userName }트레이너</h5>
										</div>
										<div style="display: flex;" class="datajon">
											<div class="agejon">나이 : ${ t.age }</div>
											<div class="genjon">
												성별 :
												<c:if test="${ t.gender == 'M' }">남자</c:if>
												<c:if test="${ t.gender == 'F' }">여자</c:if>
											</div>
